...
var express = require('express'), passport = require('passport'), util = require('util'), session = require('express-session'), SteamStrategy = require('../lib/passport-steam').Strategy;
...
app.post('/saveuser', ensureAuthenticated, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("/saveuser called");
        const fetchUser = yield prisma.User.findUnique({
            where: {
                id: req.user.user_id
            }, include: {
                userInfo: true,
        ...
        if (fetchUser == null) {
            ...
            const userInfo = yield prisma.userInfo.create({
                data: {
                    Gender: null,
                    Country: null,
                    Language: null,
            ...
            let themes = yield prisma.Themes.findMany({
                orderBy: {
                    id: 'asc'
                }
            });
            console.log(themes);
            if (themes.length == 0) {
                yield profileHelper.createThemesInDatabase(prisma);
            }
            //
            ...
            const newUserAcc = yield prisma.LinkedAccounts.create({
                data: {
...
app.post('/getUserInfo', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    //console.log("/getUserInfo called",req.body)
    try {
        let userData = yield prisma.User.findMany({
            where: {
                id: req.body.id
            },
            include: {
...
app.put('/updateUserInfo', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    //console.log("/getUserInfo called",req.body)
    try {
        let userData = yield prisma.UserInfo.update({
            where: {
                id: req.user.user_id
            },
            data: {
...
app.post('/updateFriendListVisPref', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
app.post('/updateLinkedVisPref', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const updatedUser = yield prisma.user.update({
            where: { id: req.user.user_id },
            data: {
...
app.post("/saveUserInfo", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let userData = yield prisma.User.update({
        where: {
            id: req.user.user_id
        },
        data: {
...
app.post('/userNameUpdate', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log("283" + req.body.name);
    const updateUserName = yield prisma.User.update({
        where: {
            id: req.user.user_id
        },
        data: {
...
app.post('/userThemeUpdate', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    //console.log(req.body.id)
    const updateUserTheme = yield prisma.User.update({
        where: {
            id: req.user.user_id
        },
        data: {
...
app.post("/isFriend", ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const isfrnd = yield prisma.FriendRequest.findMany({
        where: {
            OR: [
                {
...
app.get("/friendData", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const result = yield prisma.$queryRaw `select * from public."User" where id in (select reciever from public."Friends" where sender =${req.user.user_id})`;
    res.send(JSON.stringify(result));
}));
//returns the friends of your friends #endpoint
app.post("/friendsoffriendData", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const result = yield prisma.$queryRaw `select * from public."User" where id in (select reciever from public."Friends" where sender =${req.body.frnd_id})`;
    res.send(result);
}));
//TODO:testing function for notification #endpoint
app.post("/sendNoti", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
app.get("/micCheck", (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log("mic-check hit");
    res.send("works");
}));
app.get("/serverTest", (req, res) => __awaiter(this, void 0, void 0, function* () {
    res.send("works");
}));
//sends a friend request #endpoint
app.post('/addFriend', ensureAuthenticated, urlencodedParser, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const jsonObject = req.body;
        console.log(req.body);
        socketRunner.sendNotification(io, "frnd req", req.user.user_id, jsonObject.to, req.body);
        let frnddata = yield prisma.FriendRequest.findMany({
            where: {
                sender: req.user.user_id,
        ...
        if (frnddata != null) {
            let reqmanage = yield prisma.FriendRequest.deleteMany({
                where: {
                    OR: [
            ...
            let friendReq = yield prisma.FriendRequest.create({
                data: {
                    sender: req.user.user_id,
                    reciever: jsonObject.to,
                    status: 'pending'
...
app.post('/unFriend', ensureAuthenticated, urlencodedParser, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
  ...
  OR (fr.reciever = ${user_id} AND fr.sender = ${frnd_id})`;
        const result1 = yield prisma.$queryRaw `
...
app.get('/getFriendData', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const user_id = req.user.user_id;
    const result = yield prisma.$queryRaw `SELECT u.*,
        CASE
...
app.post('/searchFriend', ensureAuthenticated, urlencodedParser, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const jsonObject = req.body;
        if (req.body.searchTerm == 'noob') {
            const searchresult = yield prisma.User.findMany({
                where: {
...
app.post("/acceptFriend", ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const jsonObject = req.body;
    let friendReq = yield prisma.FriendRequest.updateMany({
        where: {
            reciever: req.user.user_id,
    ...
    let savedData = yield prisma.Friends.create({
        data: {
            sender: req.user.user_id,
            reciever: jsonObject.frnd_id
        }
    });
    let savedData1 = yield prisma.Friends.create({
        data: {
            reciever: req.user.user_id,
            sender: jsonObject.frnd_id
        }
...
app.post("/rejectFriend", ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const jsonObject = req.body;
    let friendReq = yield prisma.FriendRequest.updateMany({
        where: {
            reciever: req.user.user_id,
...
app.get('/auth/twitch/callback', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const clientId = "5q5a2eqsg77c8nf2xoxohxrfeniskg";
...
function setTwitchToken(req, res, token, refreshToken) {
    return __awaiter(this, void 0, void 0, function* () {
        let setTwitchToken = yield prisma.LinkedAccounts.upsert({
            where: {
...
app.get('/getowntwitchinfo', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let tokenFromDb = yield prisma.LinkedAccounts.findUnique({
        where: {
            userId: req.query.id
        },
        select: {
    ...
    if ((tokenFromDb === null || tokenFromDb === void 0 ? void 0 : tokenFromDb.twitchtoken) != null) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const newToken = yield refreshTwitchToken(req.query.id, refreshToken);
...
function refreshTwitchToken(userid, refreshToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch('https://id.twitch.tv/oauth2/token', requestOptions);
            const json = yield response.json();
            const accessToken = json.access_token;
            const refreshToken = json.refresh_token;
            ...
            if (json != null) {
                const updateUser = yield prisma.LinkedAccounts.update({
                    where: {
                        userId: userid,
                    },
                    data: {
...
function saveDiscordInfo(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let discordProfile = yield prisma.LinkedAccounts.upsert({
                where: {
                    userId: sessionMap.get(req.sessionID)
                },
...
app.get('/getDiscordInfo', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let discordData = yield prisma.LinkedAccounts.findUnique({
        where: {
            userId: req.query.id
        },
        select: {
    ...
    if (discordData != null && discordData.Discord != null) {
        let _a = discordData.Discord, { email, accessToken, refreshToken } = _a, filteredData = __rest(_a, ["email", "accessToken", "refreshToken"]);
...
app.get("/steamUserInfo", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let steamIdfromDb = yield prisma.User.findUnique({
        where: {
            id: req.user.user_id
        },
        select: {
    ...
    if (steamIdfromDb.steamId != null) {
        const c = yield axios.get(`https://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=${apiKey}&steamids=${steamIdfromDb.steamId}`);
...
app.get("/accountData", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let steamIdfromDb = yield prisma.User.findUnique({
        where: {
            id: req.user.user_id
        },
    ...
    if (steamIdfromDb.steamId != null) {
        const c = yield axios.get(`http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=${apiKey}&steamid=${steamIdfromDb.steamId}&include_appinfo=true&format=json`);
        let games = c.data.response.games;
        if (games == undefined || games == null) {
            games = [];
        }
        else {
            let saveGames = yield prisma.OwnedGames.upsert({
                where: {
...
app.post('/steamInfo', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    //console.log(req.body.steam_id)
    if (req.body.steam_id != null) {
        const c = yield axios.get(`https://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=${apiKey}&steamids=${req.body.steam_id}`);
        let players = c.data.response.players;
        if (players == undefined || players == null) {
            players = [];
        }
...
app.get('/activeState', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let activeStateData = yield prisma.User.findMany({
        where: {
            id: req.user.user_id
        },
        select: {
...
app.post('/activeStateChange', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const jsonObject = req.body;
    const updateUser = yield prisma.User.update({
        where: {
            id: req.user.user_id,
    ...
    const friendlist = yield prisma.$queryRaw `select reciever from public."Friends" where sender =${req.user.user_id}`;
...
app.get('/getSteamId', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let steamIdData = yield prisma.User.findMany({
        where: {
            id: req.user.user_id
        }
...
app.post('/deleteSteamId', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const updateUser = yield prisma.User.update({
        where: {
            id: req.user.user_id,
        },
...
app.get('/chatData', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let fetchedChat = yield prisma.Chat.findMany({
        where: {
            OR: [
                {
                    sender: req.user.uid,
...
app.get('/getChats', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const fetchedChat = yield prisma.$queryRaw `
...
app.post('/gameSelect', ensureAuthenticated, urlencodedParser, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let dataPresent = yield prisma.GameSelectInfo.findMany({
        where: {
            uid: req.user.user_id
        },
        select: {
    ...
    if (dataPresent.length != 0) {
        const updateselectedGames = yield prisma.GameSelectInfo.updateMany({
            where: {
                uid: req.user.user_id,
            },
            data: {
        ...
        const createselectedGames = yield prisma.GameSelectInfo.create({
            data: {
                uid: req.user.user_id,
                appid: req.body.appid,
            }
...
app.get('/getSelectedGames', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let selectedGamedata = yield prisma.GameSelectInfo.findMany({
        where: {
            uid: req.user.user_id
        },
        select: {
...
app.post('/getFrndSelectedGames', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const jsonObject = req.body;
    let selectedGamedata = yield prisma.GameSelectInfo.findMany({
        where: {
...
app.get('/getOwnedgames', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let fetchedGames = yield prisma.OwnedGames.findMany({
        where: {
            uid: req.user.user_id
        },
        select: {
...
//#endpoint
app.post('/getFrndOwnedgames', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const jsonObject = req.body;
    let fetchedGames = yield prisma.OwnedGames.findMany({
        where: {
            uid: jsonObject.frnd_id
...
//#endpoint
app.post('/savePreffredGames', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    //console.log(req.body.games);
    req.body.games.forEach((game) => __awaiter(this, void 0, void 0, function* () {
        //console.log(JSON.stringify(game));
        const savegame = yield prisma.PreferredGames.create({
            data: {
                uId: req.user.user_id,
...
//#endpoint
app.post("/updateBio", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
//#endpoint
app.post("/updateUserData", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    const updateStatus = yield prisma.userInfo.update({
        where: {
            id: req.body.data.id,
        },
        data: {
...
app.post("/updateUserSelectedLanguages", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log(req.body.list);
    const updateLang = yield prisma.userInfo.update({
        where: {
            id: req.body.data.id,
        },
        data: {
...
app.post("/chat/selectChatBg", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
...
app.get('/getThemes', ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    let themes = yield prisma.Themes.findMany({
        orderBy: {
            id: 'asc'
        }
...
app.post("/checkIfUserExists", ensureAuthenticated, (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log(req.body.userId);
    let check = yield prisma.User.findMany({
        where: {
            id: req.body.userId,
        }
    });
